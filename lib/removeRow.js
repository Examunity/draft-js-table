...
function removeRow(editorState) {
    ...
    var tableKey   = getTableForSelection(contentState, selection).getKey();
    ...
    if (!newCurrentCell || blockMap.count((block)=>block.getType()===TYPES.ROW)===1) {
